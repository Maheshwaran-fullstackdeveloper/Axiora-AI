...
const AssistantResponse = ({ answer, displayedAnswer, selectedModel }) => {
  ...
  return (
    <div className="flex items-start gap-4 bg-linear-to-br from-zinc-900/80 to-zinc-800/80 border border-zinc-700/50 rounded-2xl p-4 backdrop-blur-sm shadow-2xl sm:p-6">
      <div className="w-7 h-7 bg-linear-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center shrink-0 shadow-lg sm:w-8 sm:h-8 mt-1">
