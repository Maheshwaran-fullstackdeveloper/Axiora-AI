...
const markdownComponents = {
  ...
  blockquote: ({ children }) => (
    <blockquote className="border-l-4 border-blue-400 pl-4 italic text-zinc-300 bg-zinc-800/50 p-2 pb-1 rounded-r-lg mb-3">
      {children}
    </blockquote>
  ),
  hr: () => <hr className="border-zinc-700 my-4" />,
  th: asTag("th", "border border-zinc-700 px-4 py-2 text-left font-semibold"),
