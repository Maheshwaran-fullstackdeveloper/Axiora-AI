          ...
          <div className="mt-3 mb-2 flex flex-row items-center gap-3 flex-wrap">
            ...
            {isNovaFileModel && (
              <UploadButton
                ...
                accept=".txt,.pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx,.csv,.json,.xml,.html,.css,.js,.ts,.jsx,.tsx,.md,.py,.java,.c,.cpp,.rb,.go,.php,.sh"
            ...
            {fileAttachment && (
              <div className="flex items-center gap-2">
                <div className="px-3 py-2 bg-zinc-900 border max-w-50 truncate">
                  {fileAttachment.name}
                </div>
          ...
          <div className="flex flex-col justify-between pt-4 border-t border-zinc-700/50 gap-3 sm:flex-row sm:items-center sm:gap-0">
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-3">
              ...
              <div className="text-xs text-zinc-500 hidden sm:block">
                Press{" "}
                <kbd className="px-1.5 py-0 bg-zinc-800 border border-zinc-400">
                  Ctrl
                </kbd>{" "}
                +{" "}
